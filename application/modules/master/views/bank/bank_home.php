    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="pageheader" style="background-color: #F5F5F5;">
                <h2><i class="fa fa-home"></i> Master Bank Page <br></h2>
        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <button type="button" class="btn btn-success" id="add_bank" data-backdrop="static"
                            data-keyboard="false" data-toggle="modal"
                            data-target="#add_bank_modal" onclick="return add_bank();">
                        Add bank
                    </button>
                </div>
                <!-- /.panel-heading -->
...
<div class="modal inmodal" id="add_bank_modal" tabindex="-1" role="dialog" aria-hidden="true">
...
<div class="modal inmodal" id="update_bank_modal" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content animated fadeIn">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span
...
<script>
    function add_bank() {
        $.ajax({
            type: "POST",
            url: '<?php echo base_url() ?>master/bank/load_add_bank_from',
            success: function (result) {
                if (result) {
                    $('#load_add_bank_from').html(result);
                    return false;
                } else {
                    return false;
                }
...
<script>
    function update_bank($id) {
        $.ajax({
            type: "POST",
            url: '<?php echo base_url() ?>master/bank/load_update_bank_from/' + $id,
            success: function (result) {
                if (result) {
                    $('#load_update_bank_from').html(result);
                    return false;
                } else {
                    return false;
                }
        ...
        swal({
            ...
            function (isConfirm) {
                if (isConfirm) {
                    $.ajax({
                        type: "POST",
                        url: '<?php echo base_url() ?>master/bank/delete_bank/' + $id,
                        success: function (result) {
                            if (result) {
                                return false;
                            } else {
