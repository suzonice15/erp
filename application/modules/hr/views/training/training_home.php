    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="pageheader" style="background-color: #F5F5F5;">
                <h2><i class="fa fa-home"></i>Employee Training Info page <br></h2>
                <ol class="breadcrumb" style="background-color: #F5F5F5;">
                    <li><a href="<?php echo base_url() ?>hr/training/all_training">Dashboard</a></li>
...
<script>
    function add_training() {
        $.ajax({
            type: "POST",
            url: '<?php echo base_url() ?>hr/training/load_add_training_from',
...
<script>
    function update_training($id) {
        $.ajax({
            type: "POST",
            url: '<?php echo base_url() ?>hr/training/load_update_training_from/' + $id,
            success: function (result) {
                if (result) {
                    $('#load_from').html(result);
...
<script>
    function details_training($id) {
        $.ajax({
            type: "POST",
            url: '<?php echo base_url() ?>hr/training/load_details_training_from/' + $id,
            success: function (result) {
                if (result) {
                    $('#load_from').html(result);
...
<script>
    function search_content() {
        ...
        if ($.trim(emp_id) != "") {
            $.ajax({
                type: 'post',
                url: '<?php echo base_url(); ?>hr/training/all_training',
                data: {emp_id: emp_id},
            ...
            $.post(base_url + "hr/training/all_training/", function (data) {
                $("#ajaxdata").html(data);
            });
        }
    }
