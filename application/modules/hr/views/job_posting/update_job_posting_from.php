<?php foreach ($job_posting as $v_posting) { ?>
    <form action="" method="POST" id="update_job_posting_frm" enctype="multipart/form-data">
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    <label>Employee ID:</label> <span id="j1"></span>
                    <input type="hidden" name="id" value="<?php echo $v_posting->id;?>">
                    <input type="hidden" name="status" value="<?php echo $v_posting->status;?>">
                    <input id="emp_id" readonly="readonly" name="emp_id" value="<?php echo $v_posting->emp_id;?>" type="text" class="form-control"
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input id="basic_salary" value="<?php echo $v_posting->basic_salary;?>" name="basic_salary" type="text" class="form-control"
                ...
                <div class="form-group">
                    ...
                    <select name="department_id" id="department_id" class="form-control">
                        ...
                        <?php foreach ($department as $v_data) { ?>
                            <?php if ($v_data->id == $v_posting->department_id) { ?>
                ...
                <div class="form-group">
                    ...
                    <select onchange="select_section();" name="shift_id" id="shift_id" class="form-control">
                        ...
                        <?php foreach ($shift as $v_data) { ?>
                            <?php if ($v_data->id == $v_posting->shift_id) { ?>
                                <option selected="selected"
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    <?php
                    $CI = & get_instance();
                    $section = $CI->Main_model->getValue("shift_id='$v_posting->shift_id'", 'master_section', '*', "ID DESC");
                    ?>
                    <label>Section:</label> <span id="j4"></span>
                    <select name="section_id" id="section_id" class="form-control">
                        <option value="">Select Section</option>
                        <?php foreach ($section as $v_data) { ?>
                            <?php if ($v_data->id == $v_posting->section_id) { ?>
                                <option selected="selected"
                ...
                <div class="form-group">
                    ...
                    <select name="designation_id" id="designation_id" class="form-control">
                        ...
                        <?php foreach ($designation as $v_data) { ?>
                            <?php if ($v_data->id == $v_posting->designation_id) { ?>
                                <option selected="selected"
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input id="post_name" value="<?php echo $v_posting->post_name;?>" name="post_name" type="text" class="form-control"
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input id="joining_date" value="<?php echo $v_posting->joining_date;?>" name="joining_date" type="text" class="form-control joining_date"
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <input id="confirmation_date" value="<?php echo $v_posting->confirmation_date;?>" name="confirmation_date" type="text"
        ...
        <div class="form-group">
            <input type="submit" class="form-control btn btn-success" value="Update Job Posting">
        </div>
...
<script>
    $(document).ready(function () {
        $('#update_job_posting_frm').submit(function () {
            if (validation() == true) {
                var dataString = $('#update_job_posting_frm').serialize();
                $.ajax({
                    type: "POST",
                    url: '<?php echo base_url() ?>hr/job_posting/update_job_posting',
                    data: dataString,
                    success: function (result) {
                        if (result) {
                            $('#add_msg').html(result);
                            $('#add_msg .alert').delay(5000).fadeOut(1000);
                            $('#update_job_posting_frm').trigger("reset");
