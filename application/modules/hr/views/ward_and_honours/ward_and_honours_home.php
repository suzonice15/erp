        ...
        <div class="col-lg-12">
            <div class="pageheader" style="background-color: #F5F5F5;">
                ...
                <ol class="breadcrumb" style="background-color: #F5F5F5;">
                    <li><a href="<?php echo base_url() ?>hr/ward_and_honours/all_ward_and_honours">Dashboard</a></li>
...
<script>
    function add_ward_and_honours() {
        $.ajax({
            type: "POST",
            url: '<?php echo base_url() ?>hr/ward_and_honours/load_add_ward_and_honours_from',
            success: function (result) {
                if (result) {
                    $('#load_from').html(result);
                    $('#load_title').html("Add Employee Ward and Honours Info");
                    return false;
                } else {
                    return false;
                }
...
<script>
    function update_ward_and_honours($id) {
        $.ajax({
            type: "POST",
            url: '<?php echo base_url() ?>hr/ward_and_honours/load_update_ward_and_honours_from/' + $id,
            success: function (result) {
                if (result) {
                    $('#load_from').html(result);
...
<script>
    function search_content() {
        ...
        if ($.trim(emp_id) != "") {
            $.ajax({
                type: 'post',
                url: '<?php echo base_url(); ?>hr/ward_and_honours/all_ward_and_honours',
                data: {emp_id: emp_id},
            ...
            $.post(base_url + "hr/ward_and_honours/all_ward_and_honours/", function (data) {
                $("#ajaxdata").html(data);
            });
        }
    }
