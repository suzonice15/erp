    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="pageheader" style="background-color: #F5F5F5;">
                <h2><i class="fa fa-home"></i>Employee Family Info Page <br></h2>
                <ol class="breadcrumb" style="background-color: #F5F5F5;">
                    <li><a href="<?php echo base_url() ?>hr/family/all_family">Dashboard</a></li>
        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-heading" style="height: 55px;">
                    <div class="col-md-2">
                        <button type="button" class="btn btn-success" id="add_family" data-backdrop="static"
                    ...
                    <div class="col-md-3">
                        <input onkeyup="return search_content();" type="text" class="form-control" id="search_mobile"
                                    ...
                                    <table class="table table-striped table-responsive table-bordered table-hover">
                                        ...
                                        foreach ($family as $v_data) {
                                            ...
                                            <tr>
                                                ...
                                                <td style="width: 75px;">
                                                    <a href="#"
                                                       onclick="update_family(<?php echo $v_data->id; ?>)"
...
<script>
    function add_family() {
        $.ajax({
            type: "POST",
            url: '<?php echo base_url() ?>hr/family/load_add_family_from',
            success: function (result) {
                if (result) {
                    $('#load_from').html(result);
                    $('#load_title').html("Add Employee Family Info");
                    return false;
                } else {
                    return false;
                }
...
<script>
    function update_family($id) {
        $.ajax({
            type: "POST",
            url: '<?php echo base_url() ?>hr/family/load_update_family_from/' + $id,
            success: function (result) {
                if (result) {
                    $('#load_from').html(result);
                    $('#load_title').html("Update Employee Family Info");
                    return false;
                } else {
                    return false;
                }
...
<script>
    function search_content() {
        ...
        if ($.trim(emp_id) != "" || (search_mobile) != "") {
            $.ajax({
                type: 'post',
                url: '<?php echo base_url(); ?>hr/family/all_family',
                data: {emp_id: emp_id, mobile_no: search_mobile},
                success: function (data) {
                    $("#ajaxdata").html(data);
                }
            });
        } else {
            $.post(base_url + "hr/family/all_family/", function (data) {
                $("#ajaxdata").html(data);
            });
        }
    }
