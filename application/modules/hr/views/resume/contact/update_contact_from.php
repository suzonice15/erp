        ...
        <div class="form-group">
            <div class="row">
                <div class="col-md-4">
                    ...
                    <input id="emp_id" readonly="readonly" value="<?php echo $v_contact->emp_id ?>" required="required"
                           name="emp_id"
...
<script>
    $(document).ready(function () {
        $("#update_contact").submit(function () {
            ...
            $.ajax({
                type: "POST",
                url: '<?php echo base_url() ?>hr/my_resume/update_contact',
                data: dataString,
                success: function (result) {
                    if (result) {
                        $('#add_msg').html(result);
