...
<form action="" method="POST" id="basic_from" enctype="multipart/form-data">
    <div class="row">
        <div class="col-md-6">
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input id="mobile_no1" name="mobile_no1" type="text" class="form-control"
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input id="emp_nid" name="emp_nid" type="text" class="form-control"
                       placeholder="NID....">
            </div>
        </div>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input id="passport_number_exp_date" name="passport_number_exp_date" type="text"
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input id="birth_certificate" name="birth_certificate" type="text" class="form-control"
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="form-group">
                <label>Blood Group:</label> <span id="b19"></span>
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="form-group">
                <label>signature:</label> <span id="b21"></span>
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input id="freedom_fighter_id" name="freedom_fighter_id" type="text" class="form-control">
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group">
                    <label>Freedom fighter relation:</label>
                    <select name="freedom_fighter_relation_id" id="freedom_fighter_relation_id" class="form-control">
                        <option value="">Freedom fighter relation</option>
                        <?php foreach ($freedom_fighter_relation as $v_data) { ?>
                            <option value="<?php echo $v_data->id ?>"><?php echo $v_data->relation_name; ?></option>
                        <?php } ?>
                    </select>
                </div>
            </div>
    ...
    <div class="form-group">
        <input type="submit" class="form-control btn btn-success" value="Add basic info">
    </div>
...
<script>
    function check_duplicate() {
        ...
        $.ajax({
            type: 'POST',
            url: '<?php echo base_url()?>hr/basic/check_duplicate_data/' + emp_id,
            success: function (result) {
                if (result) {
                    alert(result);
                    $('#emp_id').val('');
...
<script>
    $(document).ready(function () {
        $('#basic_from').submit(function () {
            if (validation() == true) {
                var dataString = new FormData($(this)[0]);
                $.ajax({
                    type: "POST",
                    url: '<?php echo base_url() ?>hr/basic/create_basic',
                    data: dataString,
                    async: false,
                    success: function (result) {
                        if (result) {
