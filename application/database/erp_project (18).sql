...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 16, 2018 at 08:56 PM
...
--
-- Table structure for table `hr_emp_previous_job_history`
--

CREATE TABLE `hr_emp_previous_job_history` (
  `id` int(10) NOT NULL,
  `emp_id` varchar(50) NOT NULL,
...
--
-- Table structure for table `hr_emp_reference`
--
...
--
-- Table structure for table `hr_emp_research_and_publication`
--

CREATE TABLE `hr_emp_research_and_publication` (
  `id` int(10) NOT NULL,
  `emp_id` varchar(50) NOT NULL,
...
(33, 2, 3, 'Contact', 'hr/contact_info/all_contact_info', 'fa fa-files-o', 9, 1),
(34, 2, 3, 'Co-curricular activities', 'hr/co_curricular_activities/all_co_curricular_activities', 'fa fa-files-o', 10, 1),
(35, 2, 3, 'Experience', 'hr/experience_info/all_experience_info', 'fa fa-files-o', 11, 1);
...
--
-- Indexes for table `hr_emp_previous_job_history`
--
ALTER TABLE `hr_emp_previous_job_history`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `hr_emp_reference`
--
ALTER TABLE `hr_emp_reference`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `hr_emp_research_and_publication`
--
ALTER TABLE `hr_emp_research_and_publication`
  ADD PRIMARY KEY (`id`);
...
ALTER TABLE `hr_emp_nominee_info`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `hr_emp_previous_job_history`
--
ALTER TABLE `hr_emp_previous_job_history`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `hr_emp_reference`
--
ALTER TABLE `hr_emp_reference`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `hr_emp_research_and_publication`
--
ALTER TABLE `hr_emp_research_and_publication`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT;
--
