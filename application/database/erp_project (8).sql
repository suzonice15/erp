...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 26, 2017 at 07:29 PM
...
(1, 123456, '2017-01-01', '10:10', '5:10'),
(2, 123456, '2017-01-02', '10:00', '5:00');
...
INSERT INTO `hr_emp_academic_info` (`id`, `emp_id`, `exam_degree_id`, `grade_marks`, `academic_session`, `year_of_passing`, `institute`, `study_group_id`, `board_id`) VALUES
(1, '17001', 1, 'A', 'A', 'A', 'A', 1, 1);
...
INSERT INTO `hr_emp_job_posting` (`id`, `emp_id`, `basic_salary`, `department_id`, `shift_id`, `section_id`, `designation_id`, `post_name`, `joining_date`, `confirmation_date`) VALUES
(1, '17001', '50000', 4, 1, 3, 1, 'manager', '2017-10-10', '2017-10-10'),
(2, '17002', '50000', 4, 1, 3, 2, 'Officer', '2017-12-01', '2017-12-31'),
(3, '17003', '20000', 2, 1, 3, 2, 'manager', '2017-12-11', '2017-12-30'),
(4, '17004', '40000', 4, 1, 3, 2, 'md', '2017-12-06', '2017-12-27'),
(5, '17005', '60000', 4, 1, 3, 2, 'dmd', '2017-12-11', '2017-12-30'),
(6, '17006', '70000', 4, 1, 3, 3, 'md', '2017-12-06', '2017-12-28'),
(7, '17007', '80000', 5, 1, 3, 2, 'manager', '2017-12-11', '2017-12-29'),
(8, '17008', '40000', 4, 1, 3, 3, 'md', '2017-12-11', '2017-12-30'),
(9, '17009', '45100', 4, 1, 2, 2, 'DJ', '2017-12-12', '2017-12-31'),
(10, '17010', '54020', 5, 2, 5, 2, 'MD', '2017-12-12', '2017-12-30'),
(11, '17011', '78000', 4, 2, 5, 2, 'MD', '2017-12-12', '2017-12-29'),
(12, '17012', '4500', 3, 1, 4, 2, 'MD', '2017-12-13', '2017-12-27');
...
--
-- Table structure for table `hr_training_info`
--
...
(20, 2, 4, 'Monthly Report', 'hr/report/all_monthly_report', ' fa fa-files-o', 1, 1),
...
--
-- Indexes for table `hr_training_info`
--
ALTER TABLE `hr_training_info`
  ADD PRIMARY KEY (`id`);
...
ALTER TABLE `hr_shift_schedule`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `hr_training_info`
--
ALTER TABLE `hr_training_info`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT;
--
