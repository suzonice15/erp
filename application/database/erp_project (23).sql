...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 27, 2018 at 07:14 PM
...
--
-- Table structure for table `hr_emp_research_and_publication_info`
--

CREATE TABLE `hr_emp_research_and_publication_info` (
  `id` int(10) NOT NULL,
  `emp_id` varchar(50) NOT NULL,
...
--
-- Dumping data for table `hr_emp_research_and_publication_info`
--

INSERT INTO `hr_emp_research_and_publication_info` (`id`, `emp_id`, `title_article`, `journal_name`, `publish_by`, `journal_type`, `country`, `issn_number`, `published_date`) VALUES
...
(39, 2, 3, 'Research and Publication Info', 'hr/research_and_publication_info/all_research_and_publication_info', 'fa fa-files-o', 15, 1);
...
--
-- Indexes for table `hr_emp_research_and_publication_info`
--
ALTER TABLE `hr_emp_research_and_publication_info`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `hr_emp_research_and_publication_info`
--
ALTER TABLE `hr_emp_research_and_publication_info`
