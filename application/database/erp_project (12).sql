...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 01, 2018 at 08:35 PM
...
CREATE TABLE `hr_assigning_roster` (
  ...
  `flexiable_in_time` varchar(10) NOT NULL,
...
INSERT INTO `hr_assigning_roster` (`id`, `emp_id`, `job_type_id`, `from_date`, `to_date`, `in_time`, `flexiable_in_time`, `out_time`, `status`) VALUES
(1, '17001', 1, '2018-01-01', '2018-04-31', '9:30', '9:59', '6:30', 1);
...
(2, '17004', 2, '2017-12-01', '2017-12-19', '19', 'ff', '31-12-2017_1514739516.docx', '17006', 0),
...
--
ALTER TABLE `user_role_permission`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=479;
